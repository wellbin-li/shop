drop database if exists rootsq_bfsgk35371;

create database rootsq_bfsgk35371 default character set utf8;

use rootsq_bfsgk35371;
/*删除管理员表*/
...
/* 修改自动增长的初始值 */
ALTER TABLE forder AUTO_INCREMENT = 2017000801;
...
VALUES ('user','李文滨','user','男','15629168655','lwb1084514417@sina.com');

INSERT INTO user (login,name,pass,sex,phone,email)
VALUES ('user2','小琴','user2','女','15629168655','lwb1084514417@sina.com');
