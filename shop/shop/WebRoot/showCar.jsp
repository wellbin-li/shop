				...
				<table class="data-table cart-table" cellpadding="0" cellspacing="0">
					...
					<c:forEach items="${sessionScope.forder.sorderSet}" var="sorder" varStatus="num">
						<tr>
							...
							<td width="80px"><img src="${shop}/image/${sorder.product.pic}" width="80" height="80" />
							</td>
				...
				<div class="totals">
					...
					<div class="action_buttonbar">
						<button type="button" title="" class="checkout fr"
							...
							<font>
								<form action="${shop}/user/confirm.jsp" method="post">
									<input type="submit" value="结账（post）"/>
								</form>
							</font>
						</button>
						<button type="button" title="" class="checkout fr"
							style="background-color: #f38256;">
							<font><a href="${shop}/user/confirm.jsp">结账（get）</a></font>
						</button>
